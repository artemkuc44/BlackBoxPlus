...
//        assertTrue(HexBoard.containsElement(hexGridPanel.getHexCoordinates(), pointWithin));
//
//        assertTrue(HexBoard.containsElement(hexGridPanel.getHexCoordinates(), new Point(-4,4)));
//        assertTrue(HexBoard.containsElement(hexGridPanel.getHexCoordinates(), new Point(0,-4)));
//        assertTrue(HexBoard.containsElement(hexGridPanel.getHexCoordinates(), new Point(-4,0)));
//        assertTrue(HexBoard.containsElement(hexGridPanel.getHexCoordinates(), new Point(4,-4)));
//        assertTrue(HexBoard.containsElement(hexGridPanel.getHexCoordinates(), new Point(4,0)));
//
//
...
//        assertFalse(HexBoard.containsElement(hexGridPanel.getHexCoordinates(), pointOutside));
//        assertFalse(HexBoard.containsElement(hexGridPanel.getHexCoordinates(), new Point(4,4)));
//        assertFalse(HexBoard.containsElement(hexGridPanel.getHexCoordinates(), new Point(0,5)));
//        assertFalse(HexBoard.containsElement(hexGridPanel.getHexCoordinates(), new Point(5,0)));
//        assertFalse(HexBoard.containsElement(hexGridPanel.getHexCoordinates(), new Point(5,5)));
//        assertFalse(HexBoard.containsElement(hexGridPanel.getHexCoordinates(), new Point(324,352)));
//        assertFalse(HexBoard.containsElement(hexGridPanel.getHexCoordinates(), new Point(56,345)));
//    }
//
//    @Test
